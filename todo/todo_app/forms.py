...
class UserForm(ModelForm):
    ...
    def clean(self):
        ...
        telegram = cleaned_data.get('telegram_id')
        if len(str(telegram)) != 10:
            raise forms.ValidationError('You must enter a valid telegram id')
...
class TodoItemForm(ModelForm):
    class Meta:
        ...
        widgets = {'tags': forms.CheckboxSelectMultiple, 'title': forms.Textarea(attrs={'rows': 2}),
