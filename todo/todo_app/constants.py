all_tags = [
    "ubuntu", "windows", "vmware", "vsphere", "redhat",
    "debian", "warning", "bug", "degradation", "error",
    "critical", "cloud", "cluster", "container", "jenkins",
...
# component = ["jenkins", "docker", "database", "python", "java", "go", "webserver", "backend", "frontend"]
